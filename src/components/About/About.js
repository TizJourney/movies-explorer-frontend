  ...
  return (
    <div className="about">
      <ul className="about-info">
        <li className="about-info__item about-item__item_title">Дипломный проект включал 5 этапов</li>
        <li className="about-info__item about-item__item_title">На выполнение диплома ушло 5 недель</li>
